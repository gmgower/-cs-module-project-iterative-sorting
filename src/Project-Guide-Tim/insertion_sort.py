def simple_implementation(arr):
    ...
    for i in range(1, len(arr)):
        ...
        while j > 0 and temp < arr[j - 1]:
            # copy element to left to this positon 
            arr[j] = arr[j - 1]
...
books = [Book("Melville", "Moby Dick", "Whale stories"), Book( "Immortal William", "Hamlet", "emo Danish princess")]
